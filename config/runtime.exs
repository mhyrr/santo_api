...
#
#     PHX_SERVER=true bin/santo_api start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :santo_api, SantoApiWeb.Endpoint, server: true
end
  ...
  config :santo_api, SantoApiWeb.Endpoint,
    live_reload: [
      ...
      patterns: [
        ...
        ~r"lib/santo_api_web/router\.ex$"E,
        ~r"lib/santo_api_web/(controllers|live|components)/.*\.(ex|heex)$"E
      ]
    ]
end
...
if config_env() == :prod do
  ...
  config :santo_api, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
